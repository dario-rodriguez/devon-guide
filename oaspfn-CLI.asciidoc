...
image::images/CLI/Fun.PNG[, link="images/CLI/Fun.PNG"]

That command make use of the link:Configuration#default-configuration[default configuration], but the usage is the following:
...
image::images/CLI/FunHelp.PNG[, link="images/CLI/FunHelp.PNG"]