...
** common: contains the Spring bean configuration of http://dozer.sourceforge.net/documentation/about.html[Dozer]. find more about OASP4j Bean-Mapping https://github.com/devonfw/devon-guide/wiki/getting-started-bean-mapping-using-dozer[here]. 
