...
image::images/database-configuration/db-config1.png[,scaledwidth=100%]
...
image::images/database-configuration/db-config2.png[,scaledwidth=100%]
...
image::images/database-configuration/db-config3.png[,scaledwidth=100%]
...
image::images/database-configuration/db-config4.png[,scaledwidth=100%]
