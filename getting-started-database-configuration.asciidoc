...
image::images/database-configuration/db-config2.png[,scaledwidth="450",link="images/database-configuration/db-config2.png"]
...
image::images/database-configuration/db-config3.png[,scaledwidth="450",link="images/database-configuration/db-config3.png"]
