...
Sometimes we need to include roles and permissions to our applications. CobiGen has a template to automate this task. If you want to use this template follow the next steps:
...
[NOTE]
====
It is possible that you can't press _Finish_ button in CobiGen. This happens because you are using an old version of CobiGen and the wizard can't merge the class _PermissionConstants_. To fix it you need to delete the class _PermissionConstants.java_ and try again. 
====