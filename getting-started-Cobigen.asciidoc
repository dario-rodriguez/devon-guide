...
This happens because you need to update the templates. To do so do again right click on the _access-control-schema.cml_ and select the _Cobigen > Health Check_ option and you will see a window with a message like the following 
