...
* CI test Angular starterTemplate. Testing automatization for Angular applications (My Thai Star) in Continuous Integration environments by using Headless browsers and creating nodejs scripts. See: XXXX