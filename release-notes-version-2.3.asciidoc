...
Furthermore: an email and Twitter microservice wre integrated in my-thai-star. This is just for demonstration purposes. Microservice framework is already part of oasp4j 2.5.0
