...
image::images/setup-and-maintain-db-schemas-with-flyway/environments.jpeg[,scaledwidth=80%]
...
image::images/setup-and-maintain-db-schemas-with-flyway/how-flyway-works-2.jpeg[,scaledwidth=80%]
...
image::images/setup-and-maintain-db-schemas-with-flyway/how-flyway-works-1.jpeg[,scaledwidth=80%]
...
image::images/setup-and-maintain-db-schemas-with-flyway/how-flyway-works-3.jpeg[,scaledwidth=80%]
