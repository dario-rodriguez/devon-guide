...
*_Unbound classpath container: 'JRE System Library [JavaSE-1.8]' in project {project_name}_*, you will have to manually point installed JRE to desired version. Please, refer [here].
