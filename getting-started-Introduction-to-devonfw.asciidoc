...
== Devonfw backend tutorial

https://github.com/oasp/oasp-tutorial-sources/wiki/OASP4jGettingStartedHome[Oasp4j tutorial]: You can follow a complete tutorial for the Devonfw backend implementation based on _Oasp4j_. In this tutorial you will see an overview of the backend technologies and how to implement a basic (but fully functional) backend application based on Devonfw.