...
[NOTE]
====
In the example we are learning how to obtain the credentials of the database. If you want to know how to configure a DB2/dashDB database you can see it link:getting-started-database-configuration#bd2[here].
====
