...
In the _BaseWebSecurityConfig.java_ class located in the _core_ project in the `src/main/java/io.oasp.gastronomy.restaurant/general/configuration` folder, add the rest services path to the _unsecuredResources_
