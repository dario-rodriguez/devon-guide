...
If a parameter from the component TypeScript class has to be included you can do the following:
...
So, `param` has to be defined in the class. The default language used is defined in the following way:
