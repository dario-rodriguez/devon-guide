...
++++++++++++++++++++++++++++++++++++++
<table><tr>
  <td><img src="images/warning.png" alt="warning" width="30" /></td>
  <td>The IP modules of Devonfw are stored in https://www.jfrog.com/artifactory/[Artifactory]. In case you do not have access to that repository, as the modules are included in the Devonfw distribution, you can install them manually. To do so open a Devonfw command line (_console.bat_), go to `Devon-dist\workspaces\examples\devon` and execute the command `mvn install`.</td>
</tr></table>
++++++++++++++++++++++++++++++++++++++
