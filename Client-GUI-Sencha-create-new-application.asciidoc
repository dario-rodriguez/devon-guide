...
[NOTE]
====
You can automate these processes using devcon. With the `devon sencha workspace` command you can generate new Sencha workspaces link:devcon-user-guide#sencha-workspace[learn more here].

With the `devon sencha create` command you can create new Sencha applications link:devcon-command-reference#sencha-create[learn more here].
====
...
You can learn more about the Devon4sencha app structure link:Client-GUI-Sencha-devon4sencha-application-structure[here].
...
.*Using devcon*
[NOTE]
Remember that you can automate this process using devcon with the `devon sencha run` command link:devcon-command-reference#sencha-run[learn more here]
