...
. We will need to create the _scripts_ folder within the _Devcon Directory_. 

. Then we will need to create inside the _scripts_ folder the directory for our new module and inside it we need to add
