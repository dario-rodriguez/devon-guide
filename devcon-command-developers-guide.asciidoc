...
Once we have the devcon.jar file we have two options depending if we have are customizing a Devcon installed locally or the Devcon tool included with the Devon distributions (from version 2.1.1 onwards).
