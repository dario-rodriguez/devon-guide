...
If you are not interested in create _core_ modules and want to focus on external Javascript modules skip this section and go direcly to link:Creating-a-Javascript-module[Creating a Javascript module] part.
