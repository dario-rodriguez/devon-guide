...
---- 
 ...
 - Code inside method setCharacterEncodingFilter in ...../general/service/impl/config/WebConfig.java should be changed accordingly to use org.apache.catalina.filters.SetCharacterEncodingFilter
