...
[NOTE]
====
Learn more about layouts in OASP4Js link:Client-GUI-Angular-oasp4js-managing-angular-components#teradata-layouts[HERE]
====
...
[NOTE]
====
Learn more about Teradata data tables in OASP4Js link:Client-GUI-Angular-oasp4js-managing-angular-components#teradata-data-table[HERE]
====
