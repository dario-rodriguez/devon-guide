...
image::images/client-gui-sencha/leftPanel.PNG[Left Panel,width="300", link="https://github.com/devonfw/devon-guide/wiki/images/client-gui-sencha/leftPanel.PNG"]
