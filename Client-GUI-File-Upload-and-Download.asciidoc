...
To integrate this package (https://github.com/valor-software/ng2-file-upload/) with the customized web service for file upload (that is developed in your application), follow below steps:
