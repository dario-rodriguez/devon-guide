...
* If you face above mentioned cross browser error then add header content to the code as mentioned below:

Error: "Response to preflight request does not pass the access control check: No Access-Control-Allow-Origin header is present on the requested resource."
