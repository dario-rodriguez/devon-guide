...
You can choose single/multiple files from the buttons OR you can drag and drop them into the drop zones. All the files will be added to the upload queue. Now you can upload the files to the server.
