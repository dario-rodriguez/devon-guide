...
image::images/client-gui-sencha/selected_files_upload_syncronous.png[,width="450",selected files upload,link="https://github.com/devonfw/devon-guide/wiki/images/client-gui-sencha/selected_files_upload_syncronous.png"]
...
image::images/client-gui-sencha/ng2-file-upload.png[,width="350",File Upload Asyncronous,link="https://github.com/devonfw/devon-guide/wiki/images/client-gui-sencha/ng2-file-upload.png"]
