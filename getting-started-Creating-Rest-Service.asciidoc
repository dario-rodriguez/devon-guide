...
The service layer is responsible to expose functionality of the <<Logic Layer,logical layer>> to external consumers over a network via xref:protocol[technical protocols].
