...
[NOTE]
====
For previous version of _oasp4j_ apps you should add it in the `init()` method (in these cases you should find an AuthenticationManagerBuilder available in the class). 
