...
image::images/client-gui-sencha/chiefLogin.PNG[Chief Login,width="300", link="https://github.com/devonfw/devon-guide/wiki/images/client-gui-sencha/chiefLogin.PNG"]
...
include::Client-GUI-Sencha-extending-the-CRUD-refresh-and-double-click[]

<<<<

include::Client-GUI-Sencha-extending-the-CRUD-viewModels[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-pagination[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-search-and-filter[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-add-an-inbox[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-change-state-table[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-edit-menu-order[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-working-with-layouts[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-editable-grid[]

<<<<

include::Client-GUI-Sencha-extending-CRUD-custom-plugin[]