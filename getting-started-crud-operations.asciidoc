...
If you want to know more about how to create a new application you can visit the link:getting-started-creating-new-devonfw-oasp4j-application[Create New Application] section.
