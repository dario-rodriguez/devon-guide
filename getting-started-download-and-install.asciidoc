...
1. Unzip the Devonfw distribution into a directory of your choice. The path to the directory should contain no spaces, to prevent problems with some of the tools.
