...
.*Using devcon*
[NOTE]
image::images/devconlogo_imgonly.png[Devcon] You can do it using devcon with the command `devon dist install` link:devcon-user-guide#dist-install[learn more here]
