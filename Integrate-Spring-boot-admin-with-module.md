...
### Integrate spring boot admin with the module.  
    To setup spring boot admin for spring.io project you can refer the above wiki or simply use the module. Please follow below steps to configure with module.     
