...
As you can see, in this tutorial we have a very simple application, so we don't need another round of the TDD cycle, but in a real application, we need to do this cycle all times we need to get the success result.
