...
A Devon4sencha application will have different Controllers that will be in charge of control of several views related to the same business logic.   Each of these Views will have its own ViewController and ViewModel.   That ViewController will be in charge of managing specific events for that particular View.
