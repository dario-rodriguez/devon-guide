...
image::images/devonfw-running-sample-application/tutorial_running_sample_2_select_folder_oasp.png[,scaledwidth=80%]

1. Press "Finish"

image::images/devonfw-running-sample-application/tutorial_running_sample_3_import_maven_oasp.png[,scaledwidth=80%]
...
image::images/devonfw-running-sample-application/tutorial_running_sample_2_select_folder.png[,scaledwidth=80%]

1. Press "Finish"

image::images/devonfw-running-sample-application/tutorial_running_sample_3_import_maven.png[,scaledwidth=80%]
...
image::images/devonfw-running-sample-application/tutorial_running_sample_4_server_tab.png[,scaledwidth=80%]
...
image::images/devonfw-running-sample-application/tutorial_running_sample_5_add_remove.png[,scaledwidth=80%]
...
image::images/devonfw-running-sample-application/tutorial_running_sample_6_services.png[,scaledwidth=80%]
