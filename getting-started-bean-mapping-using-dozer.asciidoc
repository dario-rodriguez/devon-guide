...
For distributed systems, a side effect is the passing of domain objects between different systems. Typically, you don't want internal domain objects to be exposed to outside world and not allow external domain objects to bleed into your system. 
