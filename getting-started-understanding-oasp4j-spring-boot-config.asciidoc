...
As you can see, now Spring Boot will map in the variables the value of the properties under the prefix "mybean". Therefore, we just need to include these in the _application.properties_ file as we did in the _@Value_ example.
