...
== Create cordova project from sencha project

* link:Client-GUI-Cordova-How-to-start-cordova-project[How to start your cordova project from a sencha project]
