...
As a best practice we are using optimistic locking for regular end-user https://github.com/devonfw/devon-guide/wiki/getting-started-Creating-Rest-Service[services] (OLTP) and pessimistic locking for https://github.com/devonfw/devon-guide/wiki/cookbook-batch-layer[batches].
...
==== Pessimistic Locking
For back-end https://github.com/devonfw/devon-guide/wiki/getting-started-Creating-Rest-Service[services] and especially for https://github.com/devonfw/devon-guide/wiki/cookbook-batch-layer[batches] optimistic locking is not suitable. A human user shall not cause a large batch process to fail because he was editing the same entity. Therefore such use-cases use pessimistic locking what gives them a kind of priority over the human users.
...
=== Database Auditing
See https://github.com/devonfw/devon-guide/wiki/getting-started-logging-and-auditing#auditing-with-hibernate-envers[auditing guide].
...
The https://github.com/devonfw/devon-guide/wiki/getting-started-understanding-oasp4j-spring-boot-config[configuration] for Spring and Hibernate is already provided by OASP4J in our sample application and the application template. So you only need to worry about a few things to customize.
...
You can see more examples of database configurations https://github.com/devonfw/devon-guide/wiki/getting-started-database-configuration[here]
