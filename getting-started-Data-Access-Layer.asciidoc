...
----
Note that changing the name of the java constant (_GET_STAFF_MEMBER_BY_LOGIN_) can be easily done with refactoring (in Eclipse right click _Refactor > Rename_). Further you can trace where the query is used by searching the references of the constant.
