...
As a best practice we are using optimistic locking for regular end-user https://github.com/oasp/oasp4j/wiki/guide-service-layer[services] (OLTP) and pessimistic locking for https://github.com/devonfw/devon-guide/wiki/getting-started-Creating-Rest-Service [batches].
