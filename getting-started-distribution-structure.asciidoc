...
=== doc
In this folder the user can find, in pdf format, the documentation available for both starting the development tasks with the framework, and implement its more advanced features.
