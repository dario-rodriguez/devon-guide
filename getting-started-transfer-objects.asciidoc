...
The link:guide-logic-layer[logic layer] defines these transfer-objects (ETOs, CTOs, etc.) and will only pass such objects instead of link:getting-started-Data-Access-Layer#entity[persistent entities].
