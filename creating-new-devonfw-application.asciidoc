...
image::images/devonfw-create-new-app/devon-guide-newapp-choose-archetype.png[,scaledwidth=80%]
[Archetype]
...
image::images/devonfw-create-new-app/devon-guide-newapp-archetype-parameters.png[,scaledwidth=80%]
[EAR]
