...
You can create the project wherever you want, but it is a good practice to create the projects into your `workspace` directory. So, in the console, change to the directory `workspaces\main`.
...
In the New Maven Project wizard you need to choose the _oas4j-template-server archetype_, just like the image.
...
Now you need to fill the _Group Id_, _Artifact Id_, _Version_ and _Package_ for your project. 
