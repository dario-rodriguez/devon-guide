...
This command must be used within a Devonfw distrbution with version 2.0.0 or higher. You can chech your distribution's version looking at the conf/settings.json file.
...
If everything goes right a new directory _MyOasp4jsApp_ must have been created.
...
In both cases after launching the command a browser should be opened and will show the wellcome page of the _oasp4js_ app.
