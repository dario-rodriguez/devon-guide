...
- https://github.com/devonfw/devon-guide/wiki/getting-started-Creating-Rest-Service[Creating Rest Service]

- https://github.com/devonfw/devon-guide/wiki/getting-started-Cobigen[Generating code with Cobigen]
