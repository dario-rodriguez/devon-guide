...
If there is no response, you must check your Sencha installation.
But, to check if the installation is completely successful, you should compile the ExtSample app that you can obtain in the last section of this document. So, this check will be delayed until that moment.
