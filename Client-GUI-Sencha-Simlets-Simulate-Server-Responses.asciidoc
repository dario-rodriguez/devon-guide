...
## JSON Simlet
First, the simlet is registered. The following one defines an endpoint, that will catch all requests sent to /users then returns an array of objects in JSON format.
