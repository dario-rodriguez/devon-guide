...
+
Repository used for work on the guide - Similar to the according devon repository link:https://github.com/devon-guide/wiki[*devon-guide*]
...
In order to contribute to our projects, developers must follow the following link:Contributing-Development-Guidelines[development guidelines]. Other sources about contributing to devon/OASP:
...
This files should be included at the root folder or in a `docs` folder. A good resource to find the correct issues and pull requests templates for your repository is https://github.com/stevemao/github-issue-templates[this repository]. 
...
* Please read the link:Contributing-Git-Fork-guide.asciidoc[Working with forked repositories] document to learn all about this topic.
