...
You can refer the following link:oasp4j-creating-new-oasp4j-application[Creating New Application] page for more details.
...
To read more about the OASP4J application structure, click link:oasp4j-application-structure[here].