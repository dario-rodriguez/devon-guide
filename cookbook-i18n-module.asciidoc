...
3. Right click _Java Application_ 
4. Click on 'New'
5. In the dialog box that is displayed , provide name for the configuration (eg. ResouceBundleSyncronizer) and provide main class name as _net.sf.mmm.util.nls.base.ResouceBundleSyncronizer_
...
6. Click on _Arguments_ tab besides Main tab.
7. Enter program Arguments as "--locale <locale>" eg. "--locale en"
