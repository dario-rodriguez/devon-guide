...
5. create a file for a new rest controller
[source,xml]
----
...
6. server logback.xml comment non console loggers:
[source,xml]
----
...
7. Build your application with command “mvn clean install” and created the .war file and deploy it to wildfly 10 Administration console and start the application.  
