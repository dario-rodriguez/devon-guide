...
* Build your application with command “mvn clean install” and create the .war file and deploy it to wildfly 10 Administration console and start the application.  
