...
----
So, lets say , we are creating distribution for release of next version, with some additions to features etc and version becomes 2.1.1 so, change version as 2.1.1 into settings.json.
