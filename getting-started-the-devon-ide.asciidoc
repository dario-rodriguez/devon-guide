...
image::images/devon-ide/integrated-ide.png[,scaledwidth=80%,Integrated IDE]
...
image::images/devon-ide/cobigen.png[,scaledwidth=80%,Cobigen]
...
image::images/devon-ide/FindBugs1.png[,scaledwidth=80%,configure FindBugs]


To run the error analysis of FindBugs on a project, right-click on it and select the Find Bugs... → Find Bugs menu entry.

image::images/devon-ide/FindBugs2.png[,scaledwidth=80%,error analysis]
...
image::images/devon-ide/FindBugs3.png[,scaledwidth=80%,ShowView bug Explorer]

image::images/devon-ide/FindBugs4.png[,scaledwidth=80%,bug Explorer]
