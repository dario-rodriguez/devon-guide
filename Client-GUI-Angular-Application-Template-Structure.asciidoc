...
For further information regarding providing images for your own business module please check the description link:Client-GUI-Angular-Adding-Business-Module#img-files[here].
...
For further information regarding an example of a js module for the business module, please check the description link:Client-GUI-Angular-Adding-Business-Module#js-files[here].
...
The +i18n+ directory holds internationalization files with translation key-value pairs. For further information regarding adding internationalized labels to your own business module please check the description link:Client-GUI-Angular-Adding-Business-Module#i18n-files[here].
