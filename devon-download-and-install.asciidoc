...
+
image::images/devon-download-and-install//tutorial_environment_setup_2_create_workspace.png[,scaledwidth=80%]
...
+
image::images/devon-download-and-install//tutorial_environment_setup_3_proxy_maven.png[,scaledwidth=80%]
+
