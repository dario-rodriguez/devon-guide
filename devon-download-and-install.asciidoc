...
+
image::images/devonfw-download-and-install//tutorial_environment_setup_1_create_workspace.png[,scaledwidth=80%]
+
...
+
image::images/devonfw-download-and-install//tutorial_environment_setup_2_create_workspace.png[,scaledwidth=80%]
image::\images\devonfw-download-and-install\devon_guide_environment_setup_1_create_workspace.png[abc]
