...
- The microservice must have as dependency `<groupId>com.capgemini.devonfw</ groupId> <artifactId>microservices</ artifactId>` in its `pom.xml` configuration to be able to use the interceptors and the generic configuration.
