...
- If you want to use a specific UserDetails for the project, with new fields, you must extend the behavior as explained in link:devon-microservices#how-to-modify-the-UserDetails-information.
