...
Once we have a functional server and client applications we may want to package both in the same _.war_ file. To do that we are going to show the needed steps.
...
image::images/devonfw-deployment/tutorial_devon_jspackaging_process.png[scalewidth=60%,align="center"]
...
image::images/devonfw-deployment/tutorial_devon_jspackaging_process02.png[scalewidth=60%,align="center"]
...
image::images/devonfw-deployment/tutorial_devon_jspackaging_process03.png[scalewidth=60%,align="center"]
