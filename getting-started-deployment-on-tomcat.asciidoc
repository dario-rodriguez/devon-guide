...
To deploy packaged Web Application Archive (.war) file on Tomcat 7, make below changes in java core application pom.xml file.
...
. Delete  "TOMCAT_HOME/temp" and "TOMCAT_HOME/work" folders if present. These folders contain temporary files.
