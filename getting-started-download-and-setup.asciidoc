...
.*Using devcon*
[NOTE]
You can do it using devcon with the command `devon dist install`, learn more  link:devcon-command-reference#dist-install[here].
After a successful installation, you can initialize it with the command `devon dist init`, learn more link:devcon-user-guide#dist-init[here].
