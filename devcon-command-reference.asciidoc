...
Seems to be an error related to the Oasp4j Archetype version 2.1.0 that it's going to be addressed for next releases (more info link:https://github.com/oasp/oasp4j/pull/478/[here]).

However if you face the error you can apply the following workaround:
